...
include "../classes/select.php";
    ...
    if(isset($_GET['result'])){
        ...
        $vis = $get_visit->fetch_details_cond('visits', 'visit_number', $visit);
        foreach($vis as $vi){
            $customer = $vi->patient;
            $store = $vi->store;
        }
...
<div class="lab_header">
    <div class='receipt_logo'>
        <img src="../images/<?php echo $logo?>" title="logo"></div>
    <div class="company_info">
        ...
        <p><strong>Email:</strong> stjudemedicallaboratory49@gmail.com</p>
...
<?php 
    ...
    <div class="single_test">
        ...
        <div class="template_content">
            <h2 style="text-align:left;font-size:1.1rem;background:linear-gradient(45deg, rgba(226, 127, 85, 0.9), hsla(120, 100%, 25%, 0.8));text-transform:uppercase;text-align:left;color:#fff;padding:5px"><?php echo $test_name?></h2>
            <div class="patient_details">
