<?php
    ...
    <div class="add_user_form priceForm" style="width:100%; margin:5px 0;">
        <h3 style="background:var(--primaryColor); text-align:left">Remove quantity from <?php echo strtoupper($name->item_name)?><span style="color:#fff; font-weight:bold"> (<?php echo $row->quantity?>)</span></h3>
        <section  style="text-align:left;">
            <div class="inputs" style="justify-content:left">
                ...
                <div class="data" style="width:auto; display:flex;">
                    <button type="submit" id="adjust_qty" name="adjust_qty" onclick="removeQty()">Save <i class="fas fa-save"></i></button>
                    <a href="javascript:void(0)" title="close form" style='background:red; padding:10px; margin:0 5px;border-radius:15px; color:#fff' onclick="closeForm()">Close <i class='fas fa-close'></i></a>
                </div>
            </div>
        </section>   
    </div>
