        ...
        foreach($rows as $row){
            ...
            if($update_invoice){
                ...
                if($payment_type == "Multiple"){
                    ...
                    if($cash !== 0){
                        $insert_payment = new payments($user, 'Cash', $bank, $cash, $cash, $discount, $invoice, $store, $type, $customer, $date, $sold_by, 0);
                        $insert_payment->payment();
                    }
                    if($pos !== 0){
                        $insert_payment = new payments($user, 'POS', $bank, $pos, $pos, $discount, $invoice, $store, $type, $customer, $date, $sold_by, 0);
                        $insert_payment->payment();
                    }
                    if($transfer !== 0){
                        $insert_payment = new payments($user, 'Transfer', $bank, $transfer, $transfer, $discount, $invoice, $store, $type, $customer, $date, $sold_by, 0);
                        $insert_payment->payment();
                    }
                    //
                    ...
                    $insert_payment = new payments($user, $payment_type, $bank, $inv_amount, $amount_paid, $discount, $invoice, $store, $type, $customer, $date, $sold_by, 0);
                    $insert_payment->payment();
                }
