...
// echo $item;
        ...
        $rows = $get_invoice->fetch_details_cond('dispense_items', 'dispense_id', $dispense);
        foreach($rows as $row){
            $invoice = $row->invoice;
        ...
        $delete = new deletes();
        $delete->delete_item('dispense_items', 'dispense_id', $dispense);
        if($delete){

?>
<!-- display items with same invoice number -->
<div class="notify"><p><span><?php echo $name?></span> Removed from Dispense order</p></div>
