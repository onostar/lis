        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center; color:red;font-size:1,1rem">
                    ...
                    <a style="color:#fff; background:var(--otherColor);border-radius:4px;padding:5px 8px;" href="javascript:void(0)" title="show more options" onclick="showMoreWholesale('<?php echo $detail->sales_id?>')"><i class="fas fa-pen"></i></a>
                    <a style="color:#fff; background:var(--secondaryColor);border-radius:4px;padding:5px 8px;" href="javascript:void(0)" title="sell item in pack" onclick="getWholesalePack('<?php echo $detail->sales_id?>')"><i class="fas fa-box-open"></i> pack</a>
                    <!-- <a style="color:#fff; background:brown;border-radius:4px;padding:5px 8px;" href="javascript:void(0)" title="sell item in role or carton" onclick="getCartonRole('<?php echo $detail->sales_id?>')"><i class="fas fa-boxes-stacked"></i> ctn</a> -->
                </td>
                <td>
                    <?php 
