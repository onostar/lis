<?php
    ...
    $rows = $get_sponsor->fetch_details_group('sponsors', 'sponsor', 'sponsor_id', $sponsor);
    $sponsor_name = $rows->sponsor;
?>

<h2><?php echo $sponsor_name?> Services/Procedure tariff list</h2>
    <hr>
    <div class="search">
        <input type="search" id="searchRoom" placeholder="Enter keyword" onkeyup="searchData(this.value)">
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('item_list_table', '<?php echo $sponsor_name?> Service tariff list')" title="Download to excel"><i class="fas fa-file-excel"></i></a>
        <a href="javascript:void(0)" title="Go back" style='background:brown; padding:5px 8px; border-radius:10px; margin:20px 0; color:#fff' onclick="showPage('service_hmo.php')"><i class='fas fa-angle-double-left'></i></a>
    ...
    <table id="item_list_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_items->fetch_sponsor_service_tariff($sponsor);
