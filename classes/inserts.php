...
date_default_timezone_set("Africa/Lagos");
    class inserts extends Dbh{
        ...
        //post payment
        protected function post_payment($posted, $mode, $bank, $amount_due, $amount_paid, $discount, $invoice, $store, $type, $customer, $date, $sold_by, $visit){
            
            $payment = $this->connectdb()->prepare("INSERT INTO payments (amount_due, amount_paid, discount, bank, payment_mode, posted_by, invoice, store, sales_type, customer, post_date, sold_by, visit_number) VALUES (:amount_due, :amount_paid, :discount, :bank, :payment_mode, :posted_by, :invoice, :store, :sales_type, :customer, :post_date, :sold_by, :visit_number)");
            ...
            $payment->bindValue("visit_number", $visit);
            $payment->execute();
    ...
    class payments extends inserts{
        ...
        public function __construct($posted, $mode, $bank, $amount_due, $amount_paid, $discount, $invoice, $store, $type, $customer, $date, $sold_by, $visit)
        {
            $this->posted = $posted;
            $this->mode = $mode;
            $this->bank = $bank;
        ...
        public function payment(){
            $this->post_payment($this->posted, $this->mode, $this->bank, $this->amount_due, $this->amount_paid, $this->discount, $this->invoice, $this->store, $this->type, $this->customer, $this->date, $this->sold_by, $this->visit);
        }
    }
    //controller for payments
