            ...
            ?>
                <tr>
                    ...
                    <td class="prices">
                        ...
                        <a style="color:red!important; padding:5px 6px; border-radius:5px;" href="javascript:void(0)" onclick="deleteMenu('<?php echo $row->sub_menu_id?>');"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php $n++; endforeach; }?>
