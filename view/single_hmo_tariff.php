...
?>
    ...
    <div class="displays allResults" style="width:80%;">
        ...
        <hr> -->
    <a href="javascript:void(0)" title="close form" style='background:brown; padding:10px; border-radius:15px; color:#fff' onclick="showPage('hmo_tariff.php')">Return <i class='fas fa-angle-double-left'></i></a>

            <section class="addUserForm">
                <div class="add_user_form" style="width:50%; margin:10px 0; box-shadow:none">
                    <h3 style="background:var(--tertiaryColor); color:#fff; text-align:left!important;" >Add new tariff  for <?php echo $sponsor?></h3>
                    <div class="inputs">
                        <!-- bar items form -->
                        <div class="data" id="bar_items" style="width:100%; margin:2px 0">
                            <!-- <label for="item"> Search Items</label> -->
                            <input type="text" name="item" id="item" required placeholder="Search item" onkeyup="getItemDetails(this.value, 'get_hmo_price.php?sponsor=<?php echo $id?>')">
                            <div id="sales_item">
