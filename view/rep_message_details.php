    ...
    <div class="add_user_form" style="width:70%; margin:20px!important">
        ...
        <section class="addUserForm">
            ...
            <div class="inputs">
                ...
                <a href="javascript:void(0)" onclick="showPage('rep_messages.php?rep=<?php echo $rep?>')" style="background:brown; color:#fff; padding:8px; border-radius:15px;"><i class="fas fa-angle-double-left"></i> Return</a>
            </div>
        </section>    
    </div>
    </div>
