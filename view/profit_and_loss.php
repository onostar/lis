    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                // get accounts
                $get_account = new selects();
                $rows = $get_account->fetch_revenue_new($store);
            ...
            <tr>
                ...
                <td>
                    <?php
                        $csts = $get_account->fetch_sum_2colCurDate2Con('dispense_items', 'cost_price','quantity', 'date(post_date)', 'store', $store, 'dispense_status', 1);
                        foreach($csts as $cst){
                            $cost = $cst->total;
                        }
