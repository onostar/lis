...
?>
    <div class="add_user_form priceForm">
        <h3 style="background:var(--primaryColor)">Add Private Tariff for <?php echo strtoupper($item_name)?></h3>
        <?php
        ...
        <div class="addUserForm" style="display:flex; align-items:center; flex-direction:column; justify-content:center; gap:1rem; padding:20px">
            ...
            <div class="edit_buttons">
                <a href="javascript:void(0)" title="edit tariff" style='background:var(--otherColor); padding:10px; border-radius:15px; color:#fff' onclick="showPage('edit_private_tariff_form.php?item=<?php echo $item?>')">Edit Tariff <i class='fas fa-edit'></i></a>
                <a href="javascript:void(0)" title="close form" style='background:brown; padding:10px; border-radius:15px; color:#fff' onclick="showPage('private_tariff.php')">Return <i class='fas fa-angle-double-left'></i></a>
            </div>
        ...
        <section class="addUserForm" style="text-align:left;">
            <div class="inputs" style="flex-wrap:wrap; gap:1rem;">
                ...
                <div class="data" style="width:30%">
                    <button type="submit" id="change_price" name="change_price" onclick="addTariff('private_tariff.php')">Save <i class="fas fa-save"></i></button>
                    <a href="javascript:void(0)" title="close form" style='background:red; padding:10px; border-radius:5px; color:#fff' onclick="showPage('private_tariff.php')">Return <i class='fas fa-angle-double-left'></i></a>
                </div>
