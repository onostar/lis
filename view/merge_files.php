        ...
        <section class="addUserForm">
            <div class="inputs" style="justify-content:flex-start;align-items:flex-start">
                <div class="data" id="bar_items" style="width:49%; margin:0">
                    <label for="item"> Select correct patient name</label>
                    
                    <input type="hidden" name="correct_customer" id="correct_customer">
                    <input type="text" name="item" id="item" required placeholder="Input patient name or PRN" onkeyup="getCorCustomer(this.value)">
                    <div id="sales_item">
                        
                    </div>
                </div>
                <div class="data" id="bar_items" style="width:49%; margin:0">
                    <label for="item"> Select wrong patient name</label>
                    <input type="hidden" name="wrong_customer" id="wrong_customer">
                    <input type="text" name="item_raw" id="item_raw" required placeholder="Input wrong name or PRN" onkeyup="getWrongCustomer(this.value)">
