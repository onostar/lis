    ...
    <table id="room_list_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_details->fetch_details('patients');
            ...
            <tr>
                ...
                <td><a style="padding:5px 8px;border-radius:5px;background:var(--otherColor); color:#fff;" href="javascript:void(0)" title="fund account" onclick="showPage('fund_account.php?customer=<?php echo $detail->patient_id?>')"><i class="fas fa-pen"></i></a></td>
