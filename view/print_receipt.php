...
?>
<div id="printReceipt" class="displays management" style="width:100%!important">
            ...
            <tr>
                ...
                <td>
                    <?php
                        ...
                        $checkedin_by = $get_posted_by->fetch_details_cond('staffs', 'user_id', $detail->posted_by);
                        foreach($checkedin_by as $user){
                            echo $user->last_name." ".$user->other_names;
                        }
                    ?>
                </td>
                <td><button style="box-shadow:none;border-radius:4px; background:#c4c4c4; color:#000; padding:2px 5px;" title="Print receipt" onclick="printBillReceipt('<?php echo $detail->invoice?>');"><i class="fas fa-print"></i> Print</button></td>
            </tr>
            <?php $n++; endforeach;}?>
        </tbody>
    </table>
