        ...
        <tbody>
            <?php
                ...
                foreach($details as $detail):
                    ...
                    $cashier =        $checkedin_by->last_name." ".$checkedin_by->other_names;
                    }
            ?>
            <tr>
                ...
                <td>
                    <a href="javascript:void(0)" style="color:var(--otherColor)" onclick="showPage('cashier_sales.php?cashier=<?php echo $detail->posted_by?>')">
                    <?php echo $cashier?></a>               
                </td>
                <td>
                    <?php
