        ...
        <!-- <form method="POST" id="addUserForm"> -->
            <section class="addUserForm">
                <div class="inputs">
                    ...
                    <label for="customer">Update Patient Details</label>
                        <input type="text" name="customer" id="customer" oninput="getCustomerEdit(this.value)" placeholder="Enter patient name or PRN">
