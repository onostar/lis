...
<div class="displays allResults" id="bar_items">
    ...
    <h2 style="text-align:left;color:var(--secondaryColor); margin:0!important; padding:0;font-size:1rem">Patients awaiting consultation</h2>
    ...
    <table id="item_list_table" class="searchTable">
        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    <a style="padding:5px; border-radius:15px;box-shadow:1px 1px 1px #000; border:1px solid #fff; background:var(--tertiaryColor);color:#fff;"href="javascript:void(0)" onclick="showPage('new_consult.php?visit=<?php echo $detail->visit_number?>')" title="Consult for patient">Consult <i class="fas fa-pen-clip"></i></a>
                </td>
            </tr>
