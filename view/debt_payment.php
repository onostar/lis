...
<?php
    if(isset($_GET['customer'])){
        ...
        $custs = $get_customer->fetch_details_cond('patients', 'patient_id', $customer);
        foreach($custs as $cust){
            $client = $cust->last_name." ".$cust->other_names;
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <?php
                                    ...
                                    $items = $get_items->fetch_count_cond('investigations', 'invoice', $detail->invoice);
                                    echo $items;
                                ?>
                            </td>   
                            <td>
