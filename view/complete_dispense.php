...
<div id="stockin" class="displays">
    <?php
        ...
        if(isset($_GET['invoice'])){
            ...
            $strs = $get_store->fetch_details_group('dispense_items', 'store', 'invoice', $invoice);
    ...
    ?>
    <button class="page_navs" id="back" onclick="showPage('pending_dispense.php')"><i class="fas fa-angle-double-left"></i> Back</button>
    <div class="add_user_form" style="width:50%; margin:10px 0;">
        <h3 style="background:var(--moreColor); text-align:left!important;" >Dispense items from store -> <?php echo $invoice?></h3>
        ...
        <section class="addUserForm">
            <div class="inputs">
                ...
                <div class="data" style="width:100%; margin:10px 0">
                    ...
                    <input type="text" name="item" id="item" required placeholder="Search item" onkeyup="checkOtherItems(this.value, getItemDetails, 'get_item_dispense.php?invoice=<?php echo $invoice?>')">
                    <div id="sales_item">
        ...
        <div class="displays allResults" id="stocked_items" style="width:100%!important">
            ...
            <table id="stock_items_table" class="searchTable">
                ...
                <tbody>
                    <?php
                        ...
                        $details = $get_items->fetch_details_2cond('dispense_items', 'store', 'invoice', $store, $invoice);
                    ...
                    <tr>
                        ...
                        <td>
                            <a style="color:red; font-size:1rem" href="javascript:void(0) "title="delete purchase" onclick="deleteDispense('<?php echo $detail->dispense_id?>', <?php echo $detail->item?>)"><i class="fas fa-trash"></i></a>
                        </td>
            ...
            <?php
                ...
                if(gettype($details) === 'array'){
                    ...
                    $amounts = $get_total->fetch_sum_2con('dispense_items', 'cost_price', 'quantity', 'store', 'invoice', $store, $invoice);
