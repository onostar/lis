...
?>
    <div class="add_user_form priceForm">
        <h3 style="background:var(--primaryColor)">Add <?php echo strtoupper($item_name)?> Tariff for <?php echo $sponsor_name?></h3>
        <?php
        ...
        <div class="addUserForm" style="display:flex; align-items:center; flex-direction:column; justify-content:center; gap:1rem; padding:20px">
            ...
            <div class="edit_buttons">
                <a href="javascript:void(0)" title="edit tariff" style='background:var(--otherColor); padding:10px; border-radius:15px; color:#fff' onclick="showPage('edit_hmo_tariff_form.php?item=<?php echo $item?>&sponsor=<?php echo $sponsor?>')">Edit Tariff <i class='fas fa-edit'></i></a>
                <a href="javascript:void(0)" title="close form" style='background:brown; padding:10px; border-radius:15px; color:#fff' onclick="showPage('single_hmo_tariff.php?sponsor=<?php echo $sponsor?>')">Return <i class='fas fa-angle-double-left'></i></a>
            </div>
        ...
        <section class="addUserForm" style="text-align:left;">
            <div class="inputs" style="flex-wrap:wrap; gap:1rem;">
                ...
                <div class="data" style="width:30%">
                    ...
                    <input type="text" name="cost_price" id="cost_price" value="0">
                </div>
                <div class="data" style="width:30%">
                    <label for="sales_price">Agreed Amount (NGN)</label>
                    <input type="text" name="sales_price" id="sales_price" value="0">
                </div>
               
                <div class="data" style="width:30%">
                    <button type="submit" id="change_price" name="change_price" onclick="addTariff('single_hmo_tariff.php?sponsor=<?php echo $sponsor?>')">Save <i class="fas fa-save"></i></button>
                    <a href="javascript:void(0)" title="close form" style='background:red; padding:10px; border-radius:5px; color:#fff' onclick="showPage('single_hmo_tariff.php?sponsor=<?php echo $sponsor?>')">Return <i class='fas fa-angle-double-left'></i></a>
                </div>
